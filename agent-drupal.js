  ...
  try {
    ...
    return Array.from({ length: count }, function(_, i) {
      return {
        ...
        baseline: "Test content generated by QA",
        body:     "This is test content number " + (i + 1) + " of type " + typeConfig.label + " created automatically by QA."
      };
    });
  }
}
  ...
  for (var b = 0; b < bodySels.length; b++) {
    ...
    if (bvis) {
      try {
        ...
        await page.keyboard.type(item.body || item.baseline || "Test content by QA");
